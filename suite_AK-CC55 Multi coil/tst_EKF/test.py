...
def Parse_Json():
    ...
    with codecs.open((CDF_Path+"\EKF\cdf\device.jso"),encoding='utf-8') as data_file:
        ...
        with codecs.open((CDF_Path+"\EKF\cdf\help-en-GB.jso"), encoding='utf-8') as data_file:
    ...
    #        
        ...
        Parameter_File = Global_Scripts_Path+"\EKF_Parameters.csv"
        ...
        Search_file = Global_Scripts_Path+"\EKF_Search.csv"
...
#         writer_3.writerow(["", Alarm_Name, Alarm_Menu_Code])      
    ...
    for i in range (0, Main_Items_Count):
        ...
        #                                 test.log (Visibility_Idx)
                                    ...
                                    ####VISIBILITY####
                                    with open((CDF_Path+r"\EKF\cdf\visib.js")) as visibility_file:
                                        vis = visibility_file.readlines()
                                        vis = str(vis)
                                        array = []
                                        for x in vis.split('\\n'):
...
def Moving_Files():
    ...
    dest_file = Global_Scripts_Path+'\EKF.csv'                    
    shutil.copy (src_file, dest_file)
    
    PName_Dup_List=[]
    file = Global_Scripts_Path+"\EKF.csv"
