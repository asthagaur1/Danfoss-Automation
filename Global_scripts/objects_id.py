def keyAction(file):
    ...
    objects = testData.dataset("C:\gitworkspace\TestAutomation-Maintenance\Test_Automation\SourceCode\Global_scripts\Objects.xls")
    for obj in objects:
