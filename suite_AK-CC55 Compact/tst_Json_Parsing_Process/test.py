...
def Parse_Json():
    ...
    with codecs.open((CDF_Path+"\Compact_1.80\cdf\device.jso"),encoding='utf-8') as data_file:
        ...
        with codecs.open((CDF_Path+"\Compact_1.80\cdf\help-en-GB.jso"), encoding='utf-8') as data_file:
    ...
    #        
        ...
        Parameter_File = Global_Scripts_Path+"\Danfoss.Compact_Parameters.csv"
        ...
        Search_file = Global_Scripts_Path+"\Danfoss.Compact_Search.csv"
...
#         writer_3.writerow(["", Alarm_Name, Alarm_Menu_Code])      
    ...
    for i in range (0, Main_Items_Count):
        ...
        #                                 test.log (Visibility_Idx)
                                    ...
                                    ####VISIBILITY####
                                    with open((CDF_Path+r"\Compact_1.80\cdf\visib.js")) as visibility_file:
                                        vis = visibility_file.readlines()
                                        vis = str(vis)
                                        array = []
                                        for x in vis.split('\\n'):
...
def Moving_Files():
    ...
    dest_file = Global_Scripts_Path+'\Danfoss.Compact_DB.csv'                    
    shutil.copy (src_file, dest_file)
    
    PName_Dup_List=[]
    file = Global_Scripts_Path+"\Danfoss.Compact_DB.csv"
...
def Group_Count(Occurences_List):
    file = Output_Global_Path+"\Compact_Parameters_Groups.csv"
    openfile = open(file,'wt') 
...
def Compare_DB():
    file = Output_Global_Path+"\Compact_Database_Comparison.csv"
    openfile = open(file,'wt') 
    writer = csv.writer(openfile)
    writer.writerow(["Label","Name", "VariableName", "Sql_Visib_Rule", "Squish_Visib_Rule", "Result", "Sql_Help", "Squish_Help", "Result"])
     
    Sql_file = Global_Scripts_Path+"\AK_CC_Compact_DB_Sql.csv"
...
#         Sql_Name = testData.field(par, 0) 
        ...
        Squish_file = Global_Scripts_Path+"\Danfoss.Compact_DB.csv"
