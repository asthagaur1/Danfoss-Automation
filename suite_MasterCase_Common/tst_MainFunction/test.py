...
def testcontrollers(devicelist): 
    ...
    for dev in devicelist:
        ...
        #mouseClick(waitForObject("{container=':KoolProg_Window' id='imgServicetest' type='Image'}"), MouseButton.PrimaryButton)
        mouseClick(waitForObject(":KoolProg.System.Windows.Controls.DockPanel_Button_3"), MouseButton.PrimaryButton)
